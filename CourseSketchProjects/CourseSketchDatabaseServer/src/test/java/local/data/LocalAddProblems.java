...
public class LocalAddProblems {
	public static void testProblems(String courseId, String assignmentId, String mastId) {
		...
		*/
		...
		bankBuilder.setQuestionText("draw an ellipse");
		...
		try {
			resultantId = MongoInstitution.getInstance().insertBankProblem(mastId, bankBuilder.buildPartial());
	...
	public static void main(String args[]) {
		...
		testProblems("54d1a2290cf24785e69caad6", "54d1a2700cf24785e69caada", "3785f869-ccaf-49f4-9013-077cf607f71d-f3fed8fe649f0ba");
	}
 }
